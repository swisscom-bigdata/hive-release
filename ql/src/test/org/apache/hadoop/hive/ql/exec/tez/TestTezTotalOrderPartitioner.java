...
public class TestTezTotalOrderPartitioner {
	...
	private static final HiveKey[] splitStrings = new HiveKey[] {
			// -inf // 0
			new HiveKey("aabbb".getBytes(), "aabbb".hashCode()), // 1
			new HiveKey("babbb".getBytes(), "babbb".hashCode()), // 2
			new HiveKey("daddd".getBytes(), "daddd".hashCode()), // 3
			new HiveKey("dddee".getBytes(), "dddee".hashCode()), // 4
			new HiveKey("ddhee".getBytes(), "ddhee".hashCode()), // 5
			new HiveKey("dingo".getBytes(), "dingo".hashCode()), // 6
			new HiveKey("hijjj".getBytes(), "hijjj".hashCode()), // 7
			new HiveKey("n".getBytes(), "n".hashCode()), // 8
			new HiveKey("yak".getBytes(), "yak".hashCode()), // 9
	};
	...
	static {
		testStrings.add(new Check<HiveKey>(new HiveKey("aaaaa".getBytes(), "aaaaa".hashCode()), 0));
		testStrings.add(new Check<HiveKey>(new HiveKey("aaabb".getBytes(), "aaabb".hashCode()), 0));
		testStrings.add(new Check<HiveKey>(new HiveKey("aabbb".getBytes(), "aabbb".hashCode()), 1));
		testStrings.add(new Check<HiveKey>(new HiveKey("aaaaa".getBytes(), "aaaaa".hashCode()), 0));
		testStrings.add(new Check<HiveKey>(new HiveKey("babbb".getBytes(), "babbb".hashCode()), 2));
		testStrings.add(new Check<HiveKey>(new HiveKey("baabb".getBytes(), "baabb".hashCode()), 1));
		testStrings.add(new Check<HiveKey>(new HiveKey("yai".getBytes(), "yai".hashCode()), 8));
		testStrings.add(new Check<HiveKey>(new HiveKey("yak".getBytes(), "yak".hashCode()), 9));
		testStrings.add(new Check<HiveKey>(new HiveKey("z".getBytes(), "z".hashCode()), 9));
		testStrings.add(new Check<HiveKey>(new HiveKey("ddngo".getBytes(), "ddngo".hashCode()), 5));
		testStrings.add(new Check<HiveKey>(new HiveKey("hi".getBytes(), "hi".hashCode()), 6));
	};
	...
	public void testTotalOrderCustomComparator() throws Exception {
		...
		revCheck.add(new Check<HiveKey>(new HiveKey("aaaaa".getBytes(), "aaaaa".hashCode()), 9));
		revCheck.add(new Check<HiveKey>(new HiveKey("aaabb".getBytes(), "aaabb".hashCode()), 9));
		revCheck.add(new Check<HiveKey>(new HiveKey("aabbb".getBytes(), "aabbb".hashCode()), 9));
		revCheck.add(new Check<HiveKey>(new HiveKey("aaaaa".getBytes(), "aaaaa".hashCode()), 9));
		revCheck.add(new Check<HiveKey>(new HiveKey("babbb".getBytes(), "babbb".hashCode()), 8));
		revCheck.add(new Check<HiveKey>(new HiveKey("baabb".getBytes(), "baabb".hashCode()), 8));
		revCheck.add(new Check<HiveKey>(new HiveKey("yai".getBytes(), "yai".hashCode()), 1));
		revCheck.add(new Check<HiveKey>(new HiveKey("yak".getBytes(), "yak".hashCode()), 1));
		revCheck.add(new Check<HiveKey>(new HiveKey("z".getBytes(), "z".hashCode()), 0));
		revCheck.add(new Check<HiveKey>(new HiveKey("ddngo".getBytes(), "ddngo".hashCode()), 4));
		revCheck.add(new Check<HiveKey>(new HiveKey("hi".getBytes(), "hi".hashCode()), 3));
		try {
			partitioner.configure(new JobConf(conf));
			NullWritable nw = NullWritable.get();
